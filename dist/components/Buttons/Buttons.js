...
var _excluded = ["type", "size", "variant", "onClick", "disabled", "loading", "icon", "iconPosition", "label", "iconSize"];
...
var Buttons = function Buttons(_ref) {
  ...
  var buttonClass = "btn ".concat(size, " ").concat(variant, " ").concat(isLoading ? 'loading' : '', " ").concat(disabled ? 'disabled' : '', " ").concat(iconName ? 'icon-button' : '');

  // Only allow loading functionality if it's a submit button
  var isSubmitButton = type === 'submit';
  ...
  _react["default"].createElement("span", {
    className: "spinners"
  }), iconName && iconPosition === 'left' && /*#__PURE__*/_react["default"].createElement(_index["default"], {
    name: iconName,
    size: iconSize,
    className: "icon-left"
  }), label && /*#__PURE__*/_react["default"].createElement("span", null, label), iconName && iconPosition === 'right' && /*#__PURE__*/_react["default"].createElement(_index["default"], {
    name: iconName,
    size: iconSize,
